...
const script = rewire('../../collection/CPIC clomipramine Rec based on CYP2C19 and CYP2D6/recommendation');
...
describe('Give correct clomipramine recommendations', () => {
  ...
  it('Should return a poor/poor recommendation', () => {
    ...
    let result = recommendation(inputList);
    expect(result.recommendation.content).toEqual(
        expect.stringContaining("Avoid tricyclic use due to potential for side effects."));
  });
