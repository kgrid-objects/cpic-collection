...
//Get load in the js
var javascript = rewire('../../collection/99999-fk4md04x9z/v0.0.1/model/resource/phenotype');
...
var testset = [
  ...
  {"input":{"CYP3A5":"*1/*1"},"output":"Extensive metabolizer" },
    {"input":{"CYP3A5":"*1/*2"},"output":"TBD" },
      {"input":{"CYP3A5":"*1/*3"},"output":"Intermediate metabolizer" },
        {"input":{"CYP3A5":"*3/*3"},"output":"Poor metabolizer" },
]

describe('99999-fk4md04x9z/v0.0.1', function () {
