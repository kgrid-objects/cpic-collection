...
//Get load in the js
var javascript = rewire('../../collection/99999-fk4d22836k/v0.0.5/model/resource/recommendation.js');
...
describe('99999-fk4d22836k v0.0.5', function () {
  ...
  describe('Invalid inputs', function(){
    ...
    it('fields missing', function(){
      ...
      assert.equal('Incorrect/invalid input for drug citalopram', result);
    })
