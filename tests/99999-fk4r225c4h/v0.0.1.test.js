...
//Get load in the js
var javascript = rewire('../../collection/99999-fk4r225c4h/v0.0.1/model/resource/recommendation.js');
...
describe('99999-fk4cz4fm8f v0.0.1', function () {
  ...
  describe('Invalid inputs', function(){
    ...
    it('fields missing', function(){
      ...
      assert.equal('Incorrect/invalid input for drug azathioprine', result);
    })
