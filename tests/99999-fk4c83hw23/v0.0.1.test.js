...
//Get load in the js
var javascript = rewire('../../collection/99999-fk4c83hw23/v0.0.1/model/resource/recommendation.js');
...
describe('99999-fk4c83hw23 v0.0.1', function () {
  ...
  describe('Invalid inputs', function(){
    ...
    it('fields missing', function(){
      ...
      assert.equal(result, 'Incorrect/invalid input for drug ondansetron');
    })
    ...
    it('incorrect phenotype', function(){
      ...
      assert.equal('Incorrect/invalid input for drug ondansetron', result);
    })
